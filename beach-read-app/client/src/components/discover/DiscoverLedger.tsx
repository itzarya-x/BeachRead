...
interface DiscoverLedgerProps {
    mangaList: MangaResult[];
    loading: boolean;
}

export function DiscoverLedger({ mangaList, loading }: DiscoverLedgerProps) {
    const { user } = useAuth();
                        ...
                        >
                            ...
                            <div className="w-full sm:w-[60%] flex gap-5 items-center">
                                ...
                                <div className="flex flex-col justify-center min-w-0 pr-4">
                                    <h3 className="text-base sm:text-lg font-serif font-black tracking-tight text-foreground truncate group-hover:text-foreground/80 transition-colors">
                                        {manga.title}
                                    </h3>
