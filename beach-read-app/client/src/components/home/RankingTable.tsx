...
export function RankingTable({ data, loading = false, error = null }: RankingProps) {
    ...
    return (
        <section className="mx-auto mb-[88px] w-full max-w-[1280px] px-[28px] pt-[42px] transition-all duration-500">
            ...
            <div className="grid gap-x-[100px] gap-y-[24px] md:grid-cols-2">
                {loading ? (
...
function RankingRow({ manga, isAiring }: { manga: RankingItem; isAiring: boolean }) {
    ...
    return (
        <div className="group m-1 flex cursor-pointer items-center rounded-[10px] border-b border-border/30 px-4 py-[14px] transition-all duration-500 ease-in-out hover:bg-foreground/[0.04]">
