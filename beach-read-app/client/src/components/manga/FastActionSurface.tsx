...
export function FastActionSurface({ id, title, coverUrl, genres, mediaType = 'MANGA', onClose }: FastActionSurfaceProps) {
    ...
    if (noteMode) {
        return (
            <div className="flex flex-col gap-3 p-4 bg-black/90 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-300">
    ...
    return (
        <div className="flex flex-col gap-4 p-4 bg-black/90 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        <button 
                            ...
                            className={`h-10 rounded-xl flex items-center justify-center transition-all active:scale-90 border ${
                    ...
                    <div className="flex gap-2 border-t border-white/10 pt-4">
                        <button 
                            ...
                            disabled={loading}
                            className={`flex-1 h-10 rounded-xl flex items-center justify-center transition-all active:scale-95 border ${
                                libraryItem.isFavourite 
