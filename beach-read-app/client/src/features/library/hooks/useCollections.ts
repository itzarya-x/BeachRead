...
export const useCollections = () => {
    ...
    const fetchCollections = useCallback(async () => {
        ...
        try {
            ...
            const data = await apiClient.get<CollectionResponseRow[]>('/collections', {
                headers: {
    ...
    const createCollection = async (name: string, description: string, isPrivate: boolean = false) => {
        ...
        try {
            ...
            const data = await apiClient.post<CollectionResponseRow>('/collections', {
                name,
                description,
    ...
    const removeTitleFromCollection = async (collectionId: string, titleId: string) => {
        ...
        try {
            ...
            await apiClient.delete(`/collections/${collectionId}/items/${titleId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
