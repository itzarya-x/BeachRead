                ...
                <div className="w-full max-w-[480px] bg-background/40 backdrop-blur-2xl border border-white/10 p-10 md:p-14 rounded-[56px] shadow-2xl relative text-center">
                    ...
                    {verifying ? (
                        <div className="py-20 flex flex-col items-center justify-center gap-6">
                            ...
                            <p className="text-sm font-semibold tracking-tight text-muted-foreground animate-pulse">Verifying account...</p>
                        </div>
                    ) : verified ? (
                        <div className="animate-in fade-in zoom-in duration-500">
                            ...
                            <div className="space-y-4 mb-10">
                                <h1 className="text-3xl font-semibold tracking-tight text-foreground leading-none">Email Verified</h1>
                        ...
                        <div className="animate-in fade-in zoom-in duration-500">
                            ...
                            <div className="space-y-4 mb-10">
                                <h1 className="text-3xl font-semibold tracking-tight text-foreground leading-none">Invalid Link</h1>
                                <p className="text-muted-foreground text-sm font-medium leading-relaxed italic mx-auto">
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    disabled={resending}
                                    className="w-full h-14 bg-foreground text-background font-semibold text-sm rounded-xl hover:opacity-90 transition-all active:scale-95 flex items-center justify-center gap-3"
                                >
                                ...
                                <div className="pt-6 border-t border-white/5 mt-6">
                                    <Link to="/login" className="inline-flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors group">
                                        ...
                                        <span className="text-xs font-semibold tracking-tight">Return to Login</span>
                                    </Link>
                                </div>
                            </div>
                        </div>
                    ...
                    {!verifying && !verified && !error && (
                         <div className="animate-in fade-in zoom-in duration-500">
                            <div className="mx-auto w-24 h-24 rounded-3xl bg-primary/10 flex items-center justify-center text-primary mb-10 border border-primary/20 shadow-2xl">
                                <MailCheck size={48} />
                            </div>
                            <div className="space-y-4 mb-10">
                                <h1 className="text-3xl font-semibold tracking-tight text-foreground leading-none">Check Inbox</h1>
                                <p className="text-muted-foreground text-sm font-medium leading-relaxed italic mx-auto">
                            ...
                            <button
                                ...
                                className="w-full h-14 bg-foreground text-background font-semibold text-sm rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-3 active:scale-95"
                            >
                                <ArrowLeft size={18} />
                                Return to Login
                            </button>
