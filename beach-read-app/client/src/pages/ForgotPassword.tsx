                    ...
                    {!submitted ? (
                        <>
                            ...
                            <div className="mb-10">
                                ...
                                <p className="text-sm font-medium text-muted-foreground">Restore access to your account</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-2 text-left">
                                    <label className="text-xs font-semibold tracking-tight text-muted-foreground ml-1">Email Address</label>
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-14 bg-white/5 border border-white/10 rounded-xl pl-14 pr-4 text-sm font-medium focus:outline-none focus:border-primary/50 focus:bg-white/[0.08] transition-all"
                        ...
                        <div className="animate-in fade-in zoom-in duration-500">
                            ...
                            <div className="space-y-4 mb-10">
                                <h1 className="text-3xl font-semibold tracking-tight text-foreground leading-none">Email Sent</h1>
                            ...
                            <div className="p-6 bg-foreground/5 border border-foreground/10 rounded-2xl text-xs text-muted-foreground leading-relaxed font-medium mb-10">
